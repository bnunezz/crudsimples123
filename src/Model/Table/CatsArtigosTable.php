 ...
 * @method \App\Model\Entity\CatsArtigo|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\CatsArtigo|bool saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
